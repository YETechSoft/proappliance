...
export const metadata: Metadata = {
  ...
  description: 'Request appliance repair or maintenance in Boston and nearby areas. Choose your appliance and contact Pro Appliance Express to arrange service.',
};
  ...
  return (
    <div className="booking-page">
      ...
      <main className="booking-main">
        ...
        <BookingForm key={appliance} initialAppliance={appliance} />
